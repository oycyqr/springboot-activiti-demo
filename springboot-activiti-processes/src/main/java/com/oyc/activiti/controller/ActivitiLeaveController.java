...
public class ActivitiLeaveController {
     ...
     * @throws
     */
    @GetMapping("queryHistoricTaskInstance")
    public ResponseEntity queryHistoricTaskInstance(@RequestParam String processDefinitionKey,@RequestParam String processInstanceId) {
